        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 md:pl-8 lg:pl-12">
              ...
              <p className="text-secondary mb-4 sm:mb-6 text-lg ">Carlos Mercier é um apaixonado professor de ukulele com mais de 10 anos de experiência. O seu estilo de ensino único concentra-se em tornar a aprendizem divertida, acessível e livre de stress para alunos de todos os níveis e idades.</p>
