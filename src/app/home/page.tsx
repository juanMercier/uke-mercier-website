      ...
      <section className="py-12 sm:py-16 md:py-20 bg-primary">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <Link href='/sobre' className="bg-primary-foreground p-6 sm:p-8 rounded-xl shadow-md text-center hover:shadow-xl">
            ...
            <Link href='/recursos' className="bg-primary-foreground p-6 sm:p-8 rounded-xl shadow-md text-center hover:shadow-xl">
            ...
            <Link href='/eventos' className="bg-primary-foreground p-6 sm:p-8 rounded-xl shadow-md text-center hover:shadow-xl">
