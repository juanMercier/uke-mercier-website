    ...
    <>
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <Link href="/contacto" className="bg-accent hover:bg-accent-hover text-white font-bold py-2 px-4 sm:py-3 sm:px-6 rounded-full inline-flex items-center transition-colors text-sm sm:text-base">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 md:pl-8 lg:pl-12">
              ...
              <Link href="/about" className="text-tertiary hover:text-tertiary-hover font-bold inline-flex items-center text-sm sm:text-base">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-tertiary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/contacto" className="bg-white text-tertiary hover:bg-gray-100 font-bold py-2 px-4 sm:py-3 sm:px-6 rounded-full inline-flex items-center transition-colors text-sm sm:text-base">
